...
model = {
    ...
    "de_model": "src.models.sequence.SequenceDecoderModel",
...
layer = {
    ...
    "s4attention": "src.models.sequence.ss.s4.S4former",
...
callbacks = {
    ...
    "log_f1_precision_recall_heatmap": "src.callbacks.wandb.LogF1PrecRecHeatmap",
    "log_confusion_matrix": "src.callbacks.wandb.LogConfusionMatrix",
